...
public class MCliente {
    ...
    private String nombreClienteCliente;
    ...
    public String getNombreClienteCliente() {
        return nombreClienteCliente;
    }

    public void setNombreClienteCliente(String nombreClienteCliente) {
        this.nombreClienteCliente = nombreClienteCliente;
    }
    ...
    public String toString() {
        ...
        sb.append(nombreClienteCliente).append(",");
    ...
    public boolean emptyFields() {
        errores
                ...
                + MCliente.this.emptyField(nombreClienteCliente, "Nombre")
