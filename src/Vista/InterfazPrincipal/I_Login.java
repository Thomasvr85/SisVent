...
public class I_Login extends javax.swing.JPanel {
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
        ...
        MUsuario u = c.consultar(txtUser.getText());

        if (u != null && u.getUsuario().equalsIgnoreCase(txtUser.getText()) && u.getPwd().equals(String.valueOf(txtPwd.getPassword()))) {
            c.clearFields(this);
            
            formPrincipal.setUser(u);
